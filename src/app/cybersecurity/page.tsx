  ...
  return (
    <SiteShell>
      ...
      <main className="cyber-page">
        ...
        <section className="section-shell cyber-pathways"><div className="section-heading compact"><p className="command-label">$ security-pathways --choose</p><h2>Security services, engineering and product development—connected.</h2><p>Start with a commercial security review, explore NETAFANDE for endpoint visibility and operations, or examine Aptpro&rsquo;s labelled security R&D.</p></div><div className="cyber-pathway-grid"><Link href="/cybersecurity/netafande"><strong>NETAFANDE</strong><span>Kenya-first endpoint security &amp; security operations engineering platform.</span></Link><Link href="/cybersecurity/engineering"><strong>Security engineering</strong><span>Defensive tooling, security automation, AI and data-security research.</span></Link><Link href="/contact"><strong>Request a security review</strong><span>Authorised service scopes for organisations that need practical action.</span></Link></div></section>
        <ContentGrid title="How to scope a defensive security review" blocks={securityBuyerContent} />
        <FaqSection faqs={securityFaqs} />
        <RelatedLinks links={[{href:"/it-infrastructure",label:"Infrastructure support and recovery planning"},{href:"/website-design",label:"Website development with security foundations"},{href:"/cybersecurity/netafande",label:"NETAFANDE endpoint security platform"},{href:"/cybersecurity/engineering",label:"Security engineering and R&D"},{href:"/projects",label:"Public engineering experience"},{href:"/industries/veterinary",label:"Veterinary access and infrastructure requirements"},{href:"/contact",label:"Discuss an authorised security review"}]} />
